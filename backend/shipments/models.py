...
class PrasadamItem(models.Model):
    organization = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name="prasadam_items", null=True, blank=True)
    name = models.CharField(max_length=150)
    description = models.TextField(blank=True)
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    expiry_days = models.IntegerField(default=30, help_text="Shelf life in days")
